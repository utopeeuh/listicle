            ...
            <form action="/store" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="radio" class="btn-check" name="priority" id="low-create" autocomplete="off"
                            value="low" checked>
                        <label class="btn btn-secondary" for="low-create">Low</label>

                        <input type="radio" class="btn-check" name="priority" id="medium-create" autocomplete="off"
                            value="medium">
                        <label class="btn btn-secondary" for="medium-create">Medium</label>

                        <input type="radio" class="btn-check" name="priority" id="high-create" autocomplete="off"
                            value="high">
